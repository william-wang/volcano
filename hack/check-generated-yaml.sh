...
if ! diff ${VK_ROOT}/installer/volcano-development.yaml ${RELEASE_FOLDER}/volcano-v1.7.0; then
	{
		echo
		...
		&& mv ${VK_ROOT}/installer/volcano-v1.7.0 ${VK_ROOT}/installer/volcano-development.yaml' to update"
		echo
	} >&2
	false
fi
